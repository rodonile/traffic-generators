...
function master(args)
    ...
    txDev:getTxQueue(0):setRate(args_rate_adapted/2)
    txDev:getTxQueue(1):setRate(args_rate_adapted/2)
    ...
    mg.startTask("timerSlave", txDev:getTxQueue(3), rxDev:getRxQueue(3), args.size, args.flows, args.time)
