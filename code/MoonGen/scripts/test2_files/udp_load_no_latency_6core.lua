...
-- One sided traffic p1p1-->p1p2 with 6 cores that send packets
...
function master(args)
    ...
    txDev:getTxQueue(0):setRate(args_rate_adapted/6)
    txDev:getTxQueue(1):setRate(args_rate_adapted/6)
    txDev:getTxQueue(4):setRate(args_rate_adapted/6)
    txDev:getTxQueue(5):setRate(args_rate_adapted/6)
    txDev:getTxQueue(6):setRate(args_rate_adapted/6)
    txDev:getTxQueue(7):setRate(args_rate_adapted/6)
