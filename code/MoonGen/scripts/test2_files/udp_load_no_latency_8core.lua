...
function master(args)
    ...
    txDev:getTxQueue(0):setRate(args_rate_adapted/8)
    txDev:getTxQueue(1):setRate(args_rate_adapted/8)
    txDev:getTxQueue(4):setRate(args_rate_adapted/8)
    txDev:getTxQueue(5):setRate(args_rate_adapted/8)
    txDev:getTxQueue(6):setRate(args_rate_adapted/8)
    txDev:getTxQueue(7):setRate(args_rate_adapted/8)
    txDev:getTxQueue(8):setRate(args_rate_adapted/8)
    txDev:getTxQueue(9):setRate(args_rate_adapted/8)
